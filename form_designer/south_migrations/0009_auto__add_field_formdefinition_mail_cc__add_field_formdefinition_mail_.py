...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FormDefinition.mail_cc'
        db.add_column('form_designer_formdefinition', 'mail_cc', self.gf('form_designer.fields.TemplateCharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'FormDefinition.mail_bcc'
        db.add_column('form_designer_formdefinition', 'mail_bcc', self.gf('form_designer.fields.TemplateCharField')(max_length=255, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'FormDefinition.mail_cc'
        db.delete_column('form_designer_formdefinition', 'mail_cc')

        # Deleting field 'FormDefinition.mail_bcc'
        db.delete_column('form_designer_formdefinition', 'mail_bcc')
    ...
    models = {
        ...
        'form_designer.formdefinition': {
            ...
            'mail_bcc': ('form_designer.fields.TemplateCharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'mail_cc': ('form_designer.fields.TemplateCharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
