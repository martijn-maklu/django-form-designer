    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mail_cc', form_designer.fields.TemplateCharField(help_text=b'Separate several addresses with a comma. Your form fields are available as template context. Example: "admin@domain.com, {{ from_email }}" if you have a field named `from_email`.', max_length=255, null=True, verbose_name='cc form data to e-mail address', blank=True)),
                ('mail_bcc', form_designer.fields.TemplateCharField(help_text=b'Separate several addresses with a comma. Your form fields are available as template context. Example: "admin@domain.com, {{ from_email }}" if you have a field named `from_email`.', max_length=255, null=True, verbose_name='bcc form data to e-mail address', blank=True)),
                ...
                ('form_template_name', models.CharField(blank=True, max_length=255, null=True, verbose_name='form template', choices=[(b'', b'Default'), (b'html/formdefinition/forms/as_p.html', b'as paragraphs'), (b'html/formdefinition/forms/as_table.html', b'as table'), (b'html/formdefinition/forms/as_table_h.html', b'as table (horizontal)'), (b'html/formdefinition/forms/as_ul.html', b'as unordered list'), (b'html/formdefinition/forms/custom.html', b"custom implementation (don't use anymore!)"), (b'html/formdefinition/forms/meetings.html', b'Maklu-meetings'), (b'html/formdefinition/forms/meetings-tbm.html', b'TBM-RCB'), (b'html/formdefinition/forms/p-congres_com.html', b'P-congres'), (b'html/formdefinition/forms/garant25_eu.html', b'Garant-congressen')])),
